...
By default, this will start SahomeDB on port 3141. If for some reason you need to change the port, you can do so by setting the `ROCKET_PORT` environment variable. Then, you can use any HTTP client to interact with SahomeDB like curl or Postman.
...
This will build the Docker image for SahomeDB which you can then run locally. If you need guidance on how to run SahomeDB locally, please refer to this [documentation](/readme.md#getting-started).
